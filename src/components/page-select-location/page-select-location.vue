...
import MyMap from "./my-map/my-map.vue";
import LocationSearch from "./location-search/location-search.vue";
import ChooseCity from "./choose-city/choose-city.vue";
import SelectLocationWaisong from "./select-location-waisong/select-location-waisong.vue";
import StoreCard from "./store-card/store-card.vue";
